...
from knowledge_graph_agent.agents.entity_and_fact_proposal.coordinator import entity_and_fact_coordinator_agent
...
root_agent = Agent(
    ...
    sub_agents=[
        ...
        schema_proposal_coordinator_agent,
        entity_and_fact_coordinator_agent,
    ],
)
